...
import {BottomSheetComponent, type BottomSheetComponentRef,} from "@/components/ui/bottom-sheet/bottom-sheet-component";
...
export default function PostPage() {
    ...
    function onMusicSelect(music: ITrack) {
        ...
        <MainView safeArea disableTouchableWrapper={true}>
            ...
            <View className="flex-1">
                ...
                <View className="flex-1 px-4">
                    ...
                    {post.location && (
                        <View
                            className="mt-4 p-3 bg-muted-foreground/10 rounded-xl flex-row justify-between items-center z-0">
