...
const PhotoPicker = ({ onPhotoPick, onCancel }) => {
    ...
    const GRID_ITEM_SIZE = gridWidth > 0
    ...
    const renderHeader = () => (
        <View className="flex-row justify-between items-center px-4 py-3">
            ...
            <TouchableOpacity onPress={handleValidate} disabled={!selectedPhoto}>
                <Text className={`text-base font-semibold ${selectedPhoto ? "text-blue-500" : "text-gray-300"}`}>
                    Validate
                </Text>
            </TouchableOpacity>
        </View>
    ...
    const renderPermissionDenied = () => (
        <View className="justify-center items-center px-6 mt-4">
            ...
            <TouchableOpacity onPress={Linking.openSettings} className="bg-blue-500 px-5 py-2.5 rounded-lg">
    ...
    const renderPhotoGrid = () => (
        <View className="mt-6 h-1/3" ref={gridRef} onLayout={onGridLayout}>
            <FlatList
                data={permissionDenied ? [{ id: "camera" }] : [{ id: "camera" }, ...photos]}
