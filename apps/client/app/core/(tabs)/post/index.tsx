...
import MusicPicker from "@/app/core/(tabs)/post/_components/music-picker";
...
import { Alert, Animated, Keyboard, Platform, Text, TouchableOpacity, TouchableWithoutFeedback, View } from "react-native";
...
export default function PostPage() {
    ...
    const canPublish = selectedImage !== null && selectedMusic !== null && !isPublishing;
